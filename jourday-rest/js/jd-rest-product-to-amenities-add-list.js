...
app.controller('listCtr', function($scope) {
    ...
    var showUrl = jd_product_to_amenities_add_show_url;
    var getUrl = 'product-info-to-amenities-add';
    var collectionKey = 'productInfoToAmenitiesAdd';
                            ...
                            if (els) {
                                ...
                                [].forEach.call(els, function (el) {
                                    html += '<tr>' +
                                        ...
                                        '<td class="id"><a href="' + showUrl + '?el_id=' + el.id + '" target="_blank">' + el.optionLabel + '</a></td>' +
                                        '<td class="id"><a href="' + showUrl + '?el_id=' + el.id + '" target="_blank">' + el.optionPrice + '</a></td>' +
                                        '</tr>';
                                });
