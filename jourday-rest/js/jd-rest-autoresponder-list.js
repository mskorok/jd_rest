...
app.controller('listCtr', function($scope) {
    ...
    var showUrl = rest_admin_autoresponder_show;
    var getUrl = 'autoresponders';
    var collectionKey = 'autoresponders';
                            ...
                            if (els) {
                                ...
                                [].forEach.call(els, function (el) {
                                    html += '<tr>' +
                                        ...
                                        '<td class="id"><a href="' + showUrl + '?el_id=' + el.id + '" target="_blank">' + el.title + '</a></td>' +
