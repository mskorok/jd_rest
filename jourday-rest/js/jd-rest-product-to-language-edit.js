...
var app = angular.module('pluginEdit', []);
app.controller('editCtr', function($scope) {
    ...
    var getUrl = 'wp/product-to-language/edit/';
    var redirectUrl = jd_product_to_language_list_url;

    var rest_plugin_edit = {
        editUrl: '/wp/form/create/main',
        model: 'DiscountToOffer',
        formId: 'DiscountToOffer_edit_form',
        mainField: -1,
        relatedModels: {},
        modelsWithImages: [],
        imageFields: {},
