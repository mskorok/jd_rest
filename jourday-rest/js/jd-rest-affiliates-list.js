...
app.controller('reportCtr', function ($scope) {
    ...
    var showUrl = jd_affiliates_url;

    var collectionKey = 'affiliated';

    var uri = {
        'Admin': '/widget/admin/affiliates/all',
        'JourdayProvider': '/widget/jourday-provider/affiliates/all',
        'JourdayBeneficiary': '',
        'ActivityProvider': '/widget/provider/affiliates/all',
        'CustomerSupport': '/widget/customer-support/affiliates/all',
        'SalesResponsible': '',
        'Reseller': '/widget/reseller/affiliates/all'
    };
