...
app.controller('reportCtr', function ($scope) {
    ...
    var showUrl = jd_resellers_url;

    var collectionKey = 'resellers';

    var uri = {
        'Admin': '/widget/admin/resellers/all',
        'JourdayProvider': '/widget/jourday-provider/resellers/all',
        'JourdayBeneficiary': '',
        'ActivityProvider': '/widget/provider/resellers/all',
        'CustomerSupport': '/widget/customer-support/resellers/all',
        'SalesResponsible': '',
        'Reseller': '',
        'Affiliate': ''
    };
