...
app.controller('reportCtr', function ($scope) {
    ...
    var showUrl = jd_customers_url;

    var collectionKey = 'users';


    var uri = {
        'Admin': '/widget/admin/customers',
        'JourdayProvider': '/widget/jourday-provider/customers',
        'JourdayBeneficiary': '',
        'ActivityProvider': '',
        'CustomerSupport': '/widget/customer-support/customers',
        'SalesResponsible': '/widget/sales-responsible/customers',
        'Reseller': '/widget/reseller/customers'
    };
