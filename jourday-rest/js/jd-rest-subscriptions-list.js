...
app.controller('listCtr', function($scope) {
    ...
    var showUrl = rest_admin_subscriptions_show;
    var getUrl = 'subscriptions';
    var collectionKey = 'subscriptions';
                            ...
                            if (els) {
                                ...
                                [].forEach.call(els, function (el) {
                                    html += '<tr>' +
                                        ...
                                        '<td class="id"><a href="' + showUrl + '?el_id=' + el.id + '" target="_blank">' + el.description + '</a></td>' +
                                        '<td class="id"><a href="' + showUrl + '?el_id=' + el.id + '" target="_blank">' + el.start + '</a></td>' +
                                        '<td class="id"><a href="' + showUrl + '?el_id=' + el.id + '" target="_blank">' + el.end + '</a></td>' +
                                        '</tr>';
                                });
