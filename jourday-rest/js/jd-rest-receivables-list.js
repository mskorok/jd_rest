...
app.controller('reportCtr', function($scope) {
    ...
    var showUrl = jd_receivables_url;

    var collectionKey = 'revenueReceivables';
    var pdfKey = 'revenueReceivablesWithPdf';
    var excelKey = 'revenueReceivablesWithExcel';

    var uri = {
        'Admin': {
            data:'/widget/admin/receivables',
            pdf: '/widget/admin/receivables/pdf',
            excel: '/widget/admin/receivables/excel'
        },
        'JourdayProvider': {
            data:'',
            pdf: '',
        ...
        'Reseller': {
            data:'/widget/reseller/receivables',
            pdf: '/widget/reseller/receivables/pdf',
            excel: '/widget/reseller/receivables/excel'
        },
        'Affiliate': {
            data:'/widget/affiliate/receivables',
            pdf: '/widget/affiliate/receivables/pdf',
            excel: '/widget/affiliate/receivables/excel'
        }
    };
