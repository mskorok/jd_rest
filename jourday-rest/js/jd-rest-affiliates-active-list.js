...
app.controller('reportCtr', function ($scope) {
    ...
    var showUrl = jd_affiliates_active_url;

    var collectionKey = 'affiliated';

    var uri = {
        'Admin': '/widget/admin/affiliates/active',
        'JourdayProvider': '/widget/jourday-provider/affiliates/active',
        'JourdayBeneficiary': '',
        'ActivityProvider': '/widget/provider/affiliates/active',
        'CustomerSupport': '/widget/customer-support/affiliates/active',
        'SalesResponsible': '',
        'Reseller': '/widget/reseller/affiliates/active'
    };
