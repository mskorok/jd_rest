...
app.controller('reportCtr', function ($scope) {
    ...
    var showUrl = jd_resellers_active_url;

    var collectionKey = 'resellers';


    var uri = {
        'Admin': '/widget/admin/resellers/active',
        'JourdayProvider': '/widget/jourday-provider/resellers/active',
        'JourdayBeneficiary': '',
        'ActivityProvider': '/widget/provider/resellers/active',
        'CustomerSupport': '/widget/customer-support/resellers/active',
        'SalesResponsible': '',
        'Reseller': '',
        'Affiliate': ''
    };
