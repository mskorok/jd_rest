...
app.controller('showCtr', function($scope) {
    ...
    var deleteUrl = '/cancellation-policies/';
    var getUrl = 'wp/cancellation-policy/show/';
    var redirectUrl = rest_admin_cancellation_policy_list;
    var editUrl = rest_admin_cancellation_policy_edit;
