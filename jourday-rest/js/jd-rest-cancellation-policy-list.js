...
app.controller('listCtr', function($scope) {
    ...
    var showUrl = rest_admin_cancellation_policy_show;
    var getUrl = 'cancellation-policies';
    var collectionKey = 'cancellationPolicies';
                            ...
                            if (els) {
                                ...
                                [].forEach.call(els, function (el) {
                                    html += '<tr>' +
                                        ...
                                        '<td class="id"><a href="' + showUrl + '?el_id=' + el.id + '" target="_blank">' + el.cancellationWindow + '</a></td>' +
                                        '<td class="id"><a href="' + showUrl + '?el_id=' + el.id + '" target="_blank">' + el.cancellationFees + '</a></td>' +
                                        '<td class="id"><a href="' + showUrl + '?el_id=' + el.id + '" target="_blank">' + el.value + '</a></td>' +
                                        '</tr>';
                                });
