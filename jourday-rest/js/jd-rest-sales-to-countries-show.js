...
app.controller('showCtr', function($scope) {
    ...
    var deleteUrl = '/sales-responsible-to-countries/';
    var getUrl = 'wp/sales-to-countries/show/';
    var redirectUrl = rest_admin_sales_to_countries_list;
    var editUrl = rest_admin_sales_to_countries_edit;
